...
def display_header():
    ...
    print(
        "A collection of classic text-based games featuring advanced gameplay options."
    )
    print("-" * 70)
    print(
        "\nGames include Higher or Lower, Rock Paper Scissors, Hangman, MasterMind, Roulette, and Blackjack"
    )
...
def check_environment():
    ...
    if current_version < required_version:
        ...
        print(
            f"Current version: Python {current_version[0]}.{current_version[1]}"
        )
        return False
...
def main():
    ...
    try:
        ...
        try:
            ...
            print(
                f"Make sure the file 'game_selector.py' exists in: {current_dir}"
            )
            print("\nPossible solutions:")
            print(
                "1. Ensure game_selector.py is in the same directory as this script"
            )
